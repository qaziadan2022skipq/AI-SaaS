...
import { ImageDownIcon, MailQuestionIcon, MessageSquare } from "lucide-react";
...
const Conversation = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const response = await axios.post("/api/chatWithImage", {
  ...
  return (
    <div>
      <Heading
        title="Talk to Image"
        description="Ask question related to Images"
        icon={ImageDownIcon}
